#ifndef SIMPLE_XMLSS_TEST_0110_SHEET_SET_DATE_TIME_HPP
#define SIMPLE_XMLSS_TEST_0110_SHEET_SET_DATE_TIME_HPP
...
class test_0110_sheet_set_date_time : public abstract_test_case {
public:
  std::string run(void) {
    ...
    new_sheet1.set_date_time("2024-10-03T20:34:12.123",  1, 1, 0, 1);

    new_sheet1.set_date_time("2024-10-03T20:34:12.123",  2, 2, 1, 0);
    new_sheet1.set_style_id(new_style_id1, 2, 2);

    new_sheet1.set_date_time("2024-10-03T08:08:08.020",  3, 3, 0 , 1);
    new_sheet1.set_style_id(new_style_id1, 3, 3);

    new_sheet1.set_date_time("2024-10-03T20:34:12.123",  4, 4, 1, 0);
    new_sheet1.set_style_id(new_style_id2, 4, 4);

    new_sheet1.set_date_time("2024-10-03T08:08:08.020",  5, 5, 0, 1);
    new_sheet1.set_style_id(new_style_id2, 5, 5);

    new_sheet1.set_date_time("2024-10-03T20:34:12.123",  6, 6, 1, 0);
    new_sheet1.set_style_id(new_style_id3, 6, 6);

    new_sheet1.set_date_time("2024-10-03T08:08:08.020",  7, 7, 0, 1);
    new_sheet1.set_style_id(new_style_id3, 7, 7);

    new_sheet1.set_date_time("2024-10-03T20:34:12.123",  8, 8, 1, 0);
    new_sheet1.set_style_id(new_style_id4, 8, 8);

    new_sheet1.set_date_time("2024-10-03T08:08:08.020",  9, 9, 0, 1);
    new_sheet1.set_style_id(new_style_id4, 9, 9);

    new_sheet1.set_date_time("1982-02-09T00:00:00.000",  2, 7, 1, 0);
    new_sheet1.set_style_id(new_style_id5, 2, 7);

    new_sheet1.set_date_time("1982-02-09T00:00:00.000",  3, 8, 0, 1);
    new_sheet1.set_style_id(new_style_id5, 3, 8);

    new_sheet1.set_date_time("1982-02-09T00:00:00.000",  4, 9, 1, 0);
    new_sheet1.set_style_id(new_style_id6, 4, 9);

    new_sheet1.set_date_time("1982-02-09T00:00:00.000",  5, 10, 0, 1);
    new_sheet1.set_style_id(new_style_id7, 5, 10);

    new_book.print_xmlss("./test_0110_sheet_set_date_time.xml");
    return "test_0110_sheet_set_date_time";
  }
};

} // namespace simple_xmlss

#endif /* SIMPLE_XMLSS_TEST_0110_SHEET_SET_DATE_TIME_HPP */
