#ifndef SIMPLE_XMLSS_TEST_0022_BOOK_SET_STYLE_ID_HPP
#define SIMPLE_XMLSS_TEST_0022_BOOK_SET_STYLE_ID_HPP
...
class test_0022_book_set_style_id : public abstract_test_case {
public:
  std::string run(void) {
    ...
    new_book.set_style_id(style_id, "Sheet No 1", 3, 3, 8, 8);
    
    new_book.print_xmlss("./test_0022_book_set_style_id.xml");
    return "test_0022_book_set_style_id";
  }
};

} // namespace simple_xmlss

#endif /* SIMPLE_XMLSS_TEST_0022_BOOK_SET_STYLE_ID_HPP */
