#ifndef SIMPLE_XMLSS_TEST_0301_BUILDER_COMMENT_HPP
#define SIMPLE_XMLSS_TEST_0301_BUILDER_COMMENT_HPP
...
public:
  std::string run(void) {    
    ...
    unsigned int font_id3 = builder::font::instance().
                            clear().
                            set_bold(true).
                            set_size(11).
                            build();
    ...
    new_book.print_xmlss("./test_0301_builder_comment.xml");
    return "test_0301_builder_comment";
  }
};

} // namespace simple_xmlss

#endif /* SIMPLE_XMLSS_TEST_0301_BUILDER_COMMENT_HPP */
